...
when FFT communication becomes limiting; read `tides-docs/10-physics/s41467-026-73232-8_reference.pdf`
before implementation. It is not default until energy, forces, stress, and neutralization match the
FFT/Ewald path at fixed accuracy and show a measured speed or communication win.
