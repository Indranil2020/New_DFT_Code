...
// T-X4.4: Header-only mGGA TPSS device functor.
//
// The maple2c-generated source files are included here and the per-point
// evaluation is exposed as a reusable __device__ struct.  The launch code
// remains in tier1/mgga_tpss.cu.
